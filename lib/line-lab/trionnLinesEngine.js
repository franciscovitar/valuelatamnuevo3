...
export const ACTIVE_WORLD_HEIGHT = 520;
...
export const HISTORY_LINE_STYLE = {
  outer: { color: 'rgba(128, 151, 178, 0.09)', width: 0.85 },
  middle: { color: 'rgba(137, 161, 188, 0.075)', width: 0.8 },
  inner: { color: 'rgba(151, 172, 195, 0.06)', width: 0.75 },
};

export const ACTIVE_LINE_STYLE = {
  outer: { color: 'rgba(128, 151, 178, 0.19)', width: 1.05 },
  middle: { color: 'rgba(137, 161, 188, 0.17)', width: 1 },
  inner: { color: 'rgba(151, 172, 195, 0.15)', width: 0.95 },
};
...
function worldYToProgress(worldY) {
  const startY = -250;
  const endY = 6760;
