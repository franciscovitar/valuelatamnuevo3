...
export const LINE_STYLE = {
  outer: { color: 'rgba(190, 188, 194, 0.21)', width: 1.15 },
  middle: { color: 'rgba(200, 198, 202, 0.17)', width: 1 },
  inner: { color: 'rgba(214, 211, 214, 0.12)', width: 0.9 },
};

export const HISTORY_LINE_STYLE = {
  outer: { color: 'rgba(190, 188, 194, 0.082)', width: 0.85 },
  middle: { color: 'rgba(200, 198, 202, 0.066)', width: 0.8 },
  inner: { color: 'rgba(214, 211, 214, 0.054)', width: 0.75 },
};

export const ACTIVE_LINE_STYLE = {
  outer: { color: 'rgba(190, 188, 194, 0.19)', width: 1.05 },
  middle: { color: 'rgba(200, 198, 202, 0.17)', width: 1 },
  inner: { color: 'rgba(214, 211, 214, 0.145)', width: 0.95 },
};
