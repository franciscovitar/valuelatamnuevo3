/*
 * Sin copia local de la paleta: GSAP lee colores directo de las CSS custom
 * properties (ver lib/scroll/gsap.js -> paletteColor) que publica
 * app/styles/1-settings/_palette.scss. Es la unica fuente.
 */
