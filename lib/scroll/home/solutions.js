...
const SOLUTION_CARD_ACTIVE = {
  ...
  scale: 1,
  y: -1,
  borderColor: 'rgba(204, 180, 135, 0.22)',
  backgroundColor: '#1b1b20',
  boxShadow:
    '0 22px 48px -28px rgba(0, 0, 0, 0.64), 0 0 0 1px rgba(204, 180, 135, 0.10)',
  zIndex: 4,
};
...
const SOLUTION_CARD_NEXT = {
  ...
  scale: 0.992,
  y: 2,
  borderColor: 'rgba(242, 239, 232, 0.085)',
...
const SOLUTION_CARD_FUTURE = {
  ...
  scale: 0.982,
  y: 4,
  borderColor: 'rgba(242, 239, 232, 0.055)',
...
const SOLUTION_CARD_RESOLVED = {
  ...
  scale: 1,
  y: 0,
  borderColor: 'rgba(204, 180, 135, 0.13)',
  backgroundColor: '#151518',
  boxShadow: '0 18px 42px -28px rgba(0, 0, 0, 0.52), 0 0 0 1px rgba(204, 180, 135, 0.06)',
  zIndex: 2,
};
