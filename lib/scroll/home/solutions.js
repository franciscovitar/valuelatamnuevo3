...
const SOLUTION_INNER_STATES = {
  ...
  next: {
    index: { opacity: 0.82, y: 2 },
    title: { opacity: 0.68, y: 2 },
    copy: { opacity: 0.32, y: 2 },
    link: { opacity: 0.22, y: 2 },
  },
  future: {
    index: { opacity: 0.52, y: 4 },
    title: { opacity: 0.36, y: 4 },
    copy: { opacity: 0.14, y: 4 },
    link: { opacity: 0.06, y: 4 },
  },
};
