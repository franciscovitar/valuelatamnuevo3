...
/** @type {ReturnType<typeof ScrollTrigger.normalizeScroll> | null} */
let mobileScrollNormalizer = null;
...
export function initLenis(options = {}) {
  ...
  if (window.matchMedia(MOBILE_VIEWPORT_QUERY).matches) {
    ...
    if (!mobileScrollNormalizer) {
      mobileScrollNormalizer = ScrollTrigger.normalizeScroll(true);
    }
