...
export default function Financing() {
  return (
    <section
      className="finan"
      data-vl-gsap-root="financing"
      data-vl-internal-page="financiamiento"
      id="financiamiento"
    >
      <div className="wrap">
        ...
        <div className="fin-cta"><Link className="btn btn-primary" href="/#contacto">Quiero estructurar mi financiamiento</Link></div>
      </div>
    </section>
  );
}
