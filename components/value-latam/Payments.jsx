  ...
  return (
    ...
    >
      <div className="wrap">
        ...
        <div className="pay-giros"><h4>¿Operás con el exterior?</h4><p>También estructuramos tus pagos y giros internacionales —proveedores del exterior, factoring internacional, subrogación de deuda y asesoría cambiaria— por canales habilitados y dentro del marco normativo vigente.</p></div>
        <div className="pay-support"><span className="pay-group-label">Respaldo</span><p>Atención de <b>personas reales</b>, no bots ni menús eternos: te acompañamos por WhatsApp y mail mientras dejamos toda la operación montada. Todo 100% digital, con la solidez de un Agente Productor registrado en la CNV. <b>Invertir, cobrar y pagar en un solo lugar.</b></p></div>
        <div className="fin-cta"><Link className="btn btn-primary" href="/#contacto">Quiero apuntar al costo 0 en mis pagos</Link></div>
      </div>
    </section>
  );
}
