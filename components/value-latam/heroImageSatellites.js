 ...
 *
 * Los assets de abajo son PLACEHOLDERS tomados de `/public`, elegidos solo para
 * poder validar la implementacion. Reemplazarlos por los definitivos no exige
 * tocar ningun otro archivo.
 */
export const HERO_IMAGES = [
  {
    id: 'tile-estrategia',
    src: '/hero1.png', alt: '', tile: 'lg', ratio: 'wide',
  ...
  {
    id: 'tile-medios-pago',
    src: '/hero2.png', alt: '', tile: 'md', ratio: 'photo',
  ...
  {
    id: 'tile-liquidez',
    src: '/hero3.png', alt: '', tile: 'md', ratio: 'wide',
  ...
  {
    id: 'tile-resultados',
    src: '/hero4.png', alt: '', tile: 'sm', ratio: 'square',
  ...
  },
  {
    ...
    src: '/hero5.png', alt: '', tile: 'xl', ratio: 'wide',
  ...
  {
    id: 'tile-procesos-ia',
    src: '/finanzas.jpg', alt: '', tile: 'lg', ratio: 'photo',
  ...
  {
    id: 'tile-cobros',
    src: '/contacto.png', alt: '', tile: 'md', ratio: 'wide',
  ...
  {
    id: 'tile-crecimiento',
    src: '/hero-icon-01.svg', alt: '', tile: 'sm', ratio: 'square',
  ...
  {
    id: 'tile-gestion',
    src: '/hero-icon-02.svg', alt: '', tile: 'sm', ratio: 'square',
  ...
  },
  {
    ...
    src: '/hero3.png', alt: '', tile: 'sm', ratio: 'wide',
  ...
  {
    id: 'tile-respaldo',
    src: '/hero-icon-03.svg', alt: '', tile: 'xs', ratio: 'square',
  ...
  {
    id: 'tile-capital',
    src: '/hero4.png', alt: '', tile: 'xs', ratio: 'wide',
  ...
  {
    id: 'tile-mercado',
    src: '/hero-icon-04.svg', alt: '', tile: 'xs', ratio: 'square',
