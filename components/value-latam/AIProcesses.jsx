  ...
  return (
    <section className="ai" id="ia">
      <div className="wrap">
        ...
        <div className="ai-grid">
          ...
          <div className="ai-gain reveal">
            ...
            <div className="gain-cards">
              ...
              <div className="gain"><div className="gnum">×<span className="cv" data-count="10">0</span></div><p>más velocidad de respuesta operativa</p></div>
        ...
        <div className="join-section-sub reveal">
          ...
          <div className="join-cards">
            ...
            <div className="jcard"><h4>Mapa de procesos BPMN · AS-IS / TO-BE</h4><p>Tus procesos clave en dos flujos lado a lado: cómo funcionan hoy y cómo quedan automatizados, con nodos AUTO y revisión humana.</p></div>
        ...
        <div className="ai-band reveal"><p className="tagline">Tu equipo deja de cargar datos. <b>Empieza a tomar decisiones.</b></p><Link className="btn btn-primary" href="/#contacto">Quiero automatizar mis procesos</Link></div>
      </div>
    </section>
  );
}
