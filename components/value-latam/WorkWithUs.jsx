    ...
    >
      <div className="wrap">
        ...
        <div className="join-section-sub"><span className="join-sub-eyebrow">La experiencia Value Latam</span><h3 className="join-h3">Por qué trabajar con nosotros.</h3><div className="join-cards">
          ...
          <div className="jcard" data-vl-gsap-tilt=""><h4>Nuestra cultura</h4><p>Impulsamos una cultura basada en la confianza, la autonomía y la mejora continua. La colaboración y la escucha activa son la base para construir relaciones sólidas con los clientes y dentro del equipo.</p></div>
        ...
        <div className="join-section-sub"><span className="join-sub-eyebrow">Preguntas frecuentes</span><h3 className="join-h3">Lo que solés preguntarnos.</h3><div className="faq">{workFaqs.map(([summary, text]) => <details key={summary}><summary>{summary}</summary><p>{text}</p></details>)}</div></div>
        <div className="fin-cta"><Link className="btn btn-primary" href="/#contacto">Quiero ser referenciador</Link><p className="note" style={{ marginTop: 14 }}>→ Te contactamos para evaluar tu perfil y armar el esquema de trabajo</p></div>
      </div>
    </section>
  );
}
